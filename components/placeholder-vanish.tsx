	...
	return (
		...
		>
			...
			<input
				...
				type="text"
				className={cn(
					"w-full relative text-sm sm:text-base z-50 border-none bg-transparent text-foreground h-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20 font-body",
			...
			<button
				disabled={!value}
				type="submit"
				className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-sm disabled:opacity-40 bg-foreground transition duration-200 flex items-center justify-center"
			>
				<motion.svg
				...
				<AnimatePresence mode="wait">
					{!value && (
						<motion.p
							...
							className="text-sm sm:text-base font-normal text-muted-foreground pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate font-body"
						>
