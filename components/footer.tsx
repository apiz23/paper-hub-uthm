...
export default function Footer() {
	return (
		<div className="fixed bottom-0 left-0 right-0 z-10 p-4 text-center">
			<div className="flex justify-center capitalize text-xs md:text-sm">
				<Link href="https://library.uthm.edu.my/" target="_blank">
					<Link2 className="me-2 h-5 w-5 hover:text-blue-400" />
				</Link>
